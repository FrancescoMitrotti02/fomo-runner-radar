...
# La pagina si ricarica solo per visualizzare i risultati prodotti dal collector.
...
with tabs[4]: render_board("trending")
with tabs[5]: render_board("most-held")
with tabs[6]: render_board("graduated")
