...
st.markdown("""
### Logica del radar
Questa v3.2 è **FOMO-first**: usa le leaderboard FOMO di FomoScan (`trending`, `most-held`, `graduated`) e il thesis feed.
Il parser v3.2 usa lo schema reale FomoScan (`id`, `handle`, `label`, `volume`, `marketCap`, `price`, `liquidity`). Il punteggio Early Runner dà più peso a:
